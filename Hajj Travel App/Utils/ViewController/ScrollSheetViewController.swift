//
//  ScrollSheetViewController.swift
//  Hajj Travel App
//
...
open class ScrollSheetViewController: ViewController {
...
extension ViewController {
     ...
     */
    open func addPullUpController(_ pullUpController: ScrollSheetViewController) {
...
extension UIScrollView {
     ...
     */
    open func attach(to pullUpController: ScrollSheetViewController) {
